...
MIGRATION_MODULES = {"sites": "exoset.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "exoset.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Maria Carla Di Vincenzo""", "maria.divincenzo@epfl.ch")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "exoset.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "exoset.users.adapters.SocialAccountAdapter"
...
DOMAIN_NAME='http://exoset.epfl.ch'
